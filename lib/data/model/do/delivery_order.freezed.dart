...
@JsonKey(name: 'transaksi') TransactionOrder? get transaction;@JsonKey(name: 'safety_check') List<K3Foto>? get safetyCheck;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeliveryOrder&&(identical(other.transaction, transaction) || other.transaction == transaction)&&const DeepCollectionEquality().equals(other.safetyCheck, safetyCheck));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,transaction,const DeepCollectionEquality().hash(safetyCheck));

@override
String toString() {
  return 'DeliveryOrder(transaction: $transaction, safetyCheck: $safetyCheck)';
}
...
@useResult
$Res call({
@JsonKey(name: 'transaksi') TransactionOrder? transaction,@JsonKey(name: 'safety_check') List<K3Foto>? safetyCheck
});
...
/// Create a copy of DeliveryOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? transaction = freezed,Object? safetyCheck = freezed,}) {
  return _then(_self.copyWith(
transaction: freezed == transaction ? _self.transaction : transaction // ignore: cast_nullable_to_non_nullable
as TransactionOrder?,safetyCheck: freezed == safetyCheck ? _self.safetyCheck : safetyCheck // ignore: cast_nullable_to_non_nullable
as List<K3Foto>?,
  ));
}
/// Create a copy of DeliveryOrder
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'transaksi')  TransactionOrder? transaction, @JsonKey(name: 'safety_check')  List<K3Foto>? safetyCheck)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeliveryOrder() when $default != null:
return $default(_that.transaction,_that.safetyCheck);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'transaksi')  TransactionOrder? transaction, @JsonKey(name: 'safety_check')  List<K3Foto>? safetyCheck)  $default,) {final _that = this;
switch (_that) {
case _DeliveryOrder():
return $default(_that.transaction,_that.safetyCheck);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'transaksi')  TransactionOrder? transaction, @JsonKey(name: 'safety_check')  List<K3Foto>? safetyCheck)?  $default,) {final _that = this;
switch (_that) {
case _DeliveryOrder() when $default != null:
return $default(_that.transaction,_that.safetyCheck);case _:
  return null;
...
class _DeliveryOrder implements DeliveryOrder {
  const _DeliveryOrder({@JsonKey(name: 'transaksi') this.transaction, @JsonKey(name: 'safety_check') final  List<K3Foto>? safetyCheck}): _safetyCheck = safetyCheck;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DeliveryOrder&&(identical(other.transaction, transaction) || other.transaction == transaction)&&const DeepCollectionEquality().equals(other._safetyCheck, _safetyCheck));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,transaction,const DeepCollectionEquality().hash(_safetyCheck));
...
@override $TransactionOrderCopyWith<$Res>? get transaction;
...
/// Create a copy of DeliveryOrder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? transaction = freezed,Object? safetyCheck = freezed,}) {
  return _then(_DeliveryOrder(
transaction: freezed == transaction ? _self.transaction : transaction // ignore: cast_nullable_to_non_nullable
as TransactionOrder?,safetyCheck: freezed == safetyCheck ? _self._safetyCheck : safetyCheck // ignore: cast_nullable_to_non_nullable
as List<K3Foto>?,
  ));
}
...
as String,safetyCheckOriginator: null == safetyCheckOriginator ? _self.safetyCheckOriginator : safetyCheckOriginator // ignore: cast_nullable_to_non_nullable
as String,safetyCheckOriginatorBy: null == safetyCheckOriginatorBy ? _self.safetyCheckOriginatorBy : safetyCheckOriginatorBy // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
